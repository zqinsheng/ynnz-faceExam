 ...
 * 
 */
public interface IExamPersonService extends IBaseService<ExamPerson,Integer> {

    ExamPerson findByStuNumber(String stuNumber);

    List<ExamPerson> findAllByStuNumber(List<String> stuNumbers);
}