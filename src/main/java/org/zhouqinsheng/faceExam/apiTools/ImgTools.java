...
public class ImgTools {
    ...
    public static void main(String[] args) throws IOException {
        File img = new File("D:/uploadImg/2019-05-23-1eeecb76-45cf-45b3-9ee2-beb1f099439f.jpg");
        FileOutputStream fos = new FileOutputStream("D:/uploadImg/yasuo.jpg");
        // ImgTools.thumbnail(img, 100, 100, fos);
        // ImgTools.cut_w_h(img, 230, 200, fos);
        //ImgTools.thumbnail_w_h(img, 100, 0, fos);
        ImgTools.thumbnail_w_h(img,400,400,fos);
    }
