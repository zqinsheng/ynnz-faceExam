package org.zhouqinsheng.faceExam;
...
@EnableJpaRepositories(basePackages = {"org.zhouqinsheng.faceExam"},
	repositoryFactoryBeanClass = BaseRepositoryFactoryBean.class//指定自己的工厂
)
@SpringBootApplication
public class FaceExamApplication {
	public static void main(String[] args) {
		SpringApplication.run(FaceExamApplication.class,args);
	}
